...
class EmailVerifier
{
    ...
    private function generateSignature(string $verifyEmailRouteName, int $userId, string $email): VerifyEmailSignatureComponents
    {
        return $this->verifyEmailHelper->generateSignature($verifyEmailRouteName, $userId, $email);
    }
    ...
    {
        $this->verifyEmailHelper->validateEmailConfirmation($uri, $userId, $email);
    }
